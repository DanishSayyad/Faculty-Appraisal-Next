...
function AppraisalContent() {
  ...
  const handleTabChange = (tab: string) => {
    setActiveTab(tab);
    router.replace(`/director/appraisal?tab=${tab}`, { scroll: false });
  };
  ...
  const userDesignation = (user?.designation as DesignationValue) ?? "Professor";
...
export default function DirectorAppraisalPage() {
  return (
